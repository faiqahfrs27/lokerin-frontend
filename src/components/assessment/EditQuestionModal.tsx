import { useUpdateQuestion } from "../../hooks/useAssessmentDetail";
...
function EditQuestionModal({ assessmentId, question, onClose }: EditQuestionModalProps) {
  const { form, onSubmit, isPending } = useUpdateQuestion(
    assessmentId,
    question.id,
    {
...
function ModalHead() {
  return (
    <div className="modal__head">
      <p className="modal__kicker">Edit question</p>
      <h2 className="modal__title">Update question</h2>
    </div>
  );
}
