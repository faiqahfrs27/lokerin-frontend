        ...
        {step === "success" ? (
          ...
          >
            {hasTest && (
              ...
              >
                ⚠️ This job requires a pre-selection test. Make sure you've
                completed it before applying.
              </div>
            )}
            ...
            <div className="ff">
              <label className="ff-label">
                Upload CV <span style={{ color: "var(--danger-500)" }}>*</span>
              </label>
              <div
                ...
                style={{
                  ...
                  background: cvFile ? "var(--brand-soft)" : "var(--surface)",
                }}
              >
                <FileUp
                  size={24}
                  style={{
                    color: cvFile ? "var(--brand-fg)" : "var(--fg-3)",
                    margin: "0 auto 8px",
                  }}
                />
                {cvFile ? (
