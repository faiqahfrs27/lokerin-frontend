  ...
  return (
    <>
      ...
      {isUnverified && (
        ...
        >
          ⚠️ Your email is not verified yet. Please check your inbox or{" "}
          <Link
            to="/verify-email"
            style={{ color: "var(--warning-fg)", fontWeight: 700 }}
          >
      ...
      <main>
          ...
          <div className="container">
            <div className="hero-copy">
              <span className="kicker">
                Built for Gen Z. Made in Indonesia.
              </span>
              <h1 className="t-h1 hero-h1">
                Find your next <span className="orange-word">loker</span>.
              </h1>
              <p className="hero-sub">
                Smart, location-based job discovery. Skill assessments with real
                certificates. CV that lands the call back. Tanpa drama.
              </p>
              ...
              <div className="hero-stats">
                ...
                <div>
                  <strong>340</strong> companies
                </div>
                <div>
                  <strong>15,000+</strong> alumni hired
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="loc-grid">
            {SAMPLE_LOCATIONS.map((loc) => (
              <button
                key={loc.city}
                className="loc-card"
                onClick={() => navigate(`/jobs?city=${loc.city}`)}
              >
                ...
                <div className="loc-text">
                  ...
                  <div className="loc-count">
                    {loc.count.toLocaleString("id-ID")} jobs
                  </div>
                </div>
        ...
        <section className="container section">
          ...
          <h2 className="t-h3" style={{ margin: "8px 0 18px" }}>
            By category
          </h2>
        ...
        <section className="container section">
          <div className="cta-strip">
            <div>
              ...
              <h2
                className="t-h2"
                style={{ color: "white", margin: "8px 0 8px" }}
              >
                Build a CV in 4 minutes.
              </h2>
              <p
                style={{
              ...
              >
                Templates designed for Indonesian companies. Auto-fills from
                your profile. Export to PDF, no watermark.
              </p>
            </div>
            <Link
              to="/pricing"
